...
const Register = () => {
  ...
  return (
    <Access onClose={() => navigate('/home')}>
        <div className='relative flex flex-col w-[95%] sm:w-[640px] h-[95%] space-y-4 p-8 bg-white rounded-xl shadow-md'>
            <div className='flex flex-col w-full h-fit items-center justify-center text-[rgb(0,175,240)]'>
                <PiUserDuotone size={64}/>
                <span className='text-lg font-helveticaNeueRegular uppercase tracking-wider'>Register</span>
            </div>
            <Scrollable vertical={true}>
                <div className='flex flex-col w-full h-fit space-y-4'>
                    <Inputs inputs={inputs} minWidth={minWidth} paddingX={0} spaceX={32} id='register' setCalcWidth={setInputWidth}/>
