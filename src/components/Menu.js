    ...
    <div style={{backdropFilter:'blur(20px)'}}
        ...
        <div className='flex flex-row w-full h-fit px-2 space-x-2 items-center overflow-hidden shrink-0'>
            <button onClick={onMenu}
                className={`flex w-10 h-10 items-center justify-center text-[rgb(68,71,70)] ${screenSize !== 'xs'?'hover:bg-[rgba(0,175,240,.2)]':''} rounded-xl shrink-0`}>
                <PiList size={20}/>
            </button>
            <NavLink to={'/home'}>
        ...
        <div className={`${screenSize === 'xs'?'hidden':'flex'} flex-col w-full h-fit sm:h-full justify-between overflow-hidden`}>
